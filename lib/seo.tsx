  ...
  '@graph': [
    {
      ...
      description:
        'شهرشهر (شهروند سبز) سامانهٔ خدمات شهری است که با همکاری شهرداری‌ها خدمات شهری را از طریق تلفن همراه به شهروندان می‌رساند. نخستین خدمت فعال آن، جمع‌آوری و خرید پسماند خشک از درِ خانه با توزین در محل و پرداخت به کیف پول است.',
