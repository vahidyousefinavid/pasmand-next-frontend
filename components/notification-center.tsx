...
const LIST_PATH = '/api/v1/notifications';
const READ_PATH = '/api/v1/notifications/read';
...
export default function NotificationCenter() {
   ...
   * was sent — React logged a hydration error on every page carrying the header
   * and threw the tree away to recover. State plus an effect keeps the two
   * passes identical; the bell appears one tick later, which nobody can see.
   */
      ...
      {open && (
        ...
        >
          ...
          >
            ...
            {/* The dropdown holds the newest few; everything else — filters,
                older items, the full text of one — lives on the page. */}
            {items.length === 0 ? (
