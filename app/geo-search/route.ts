 ...
 *
 * **Not** under `/api/`: nginx routes that whole prefix to the Express backend
 * before Next ever sees it, so a route handler there is unreachable — which is
 * why the two `/api/neshan/*` handlers in this app have never once run.
 */
